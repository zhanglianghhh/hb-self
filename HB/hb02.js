    ...
    series: [
        {
            name: 'FIL*(-3)',
            type: 'line',
            data: [-1.97, 0, -13.46, -8.16, 0, 0, 0, 0]
        },
        {
            name: 'FIL*3',
            type: 'line',
            data: [-15.35, 0, -3.02, -5.95, 0, 0, 0, 0]
        },
        {
            name: 'LINK*(-3)',
            type: 'line',
            data: [19.19, 0, -1.99, 14.89, 0, 0, 0, 0]
        },
        {
            name: 'LINK*3',
            type: 'line',
            data: [-3.03, 0, 15.05, -2.82, 0, 0, 0, 0]
        },
        {
            name: 'LTC*(-3)',
            type: 'line',
            data: [18.56, 0, -2.84, 14.48, 0, 0, 0, 0]
        },
        {
            name: 'LTC*3',
            type: 'line',
            data: [-5.21, 0, 6.11, -3.12, 0, 0, 0, 0]
        },
        {
            name: 'XRP*(-3)',
            type: 'line',
            data: [16.36, 0, -0.90, 11.81, 0, 0, 0, 0]
        },
        {
            name: 'XRP*3',
            type: 'line',
            data: [-13.71, 0, 1.27, -14.15, 0, 0, 0, 0]
        }
    ]
};
