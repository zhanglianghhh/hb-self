    ...
    series: [
        {
            name: 'FIL*(-3)',
            type: 'line',
            data: [-1.97, 0, -13.46, -8.16, -5.04, -1.97, -3.20, 0]
        },
        {
            name: 'FIL*3',
            type: 'line',
            data: [-15.35, 0, -3.02, -5.95, -10.49, -12.22, -13.79, 0]
        },
        {
            name: 'LINK*(-3)',
            type: 'line',
            data: [19.19, 0, -1.99, 14.89, 20.85, 19.51, 23.48, 0]
        },
        {
            name: 'LINK*3',
            type: 'line',
            data: [-3.03, 0, 15.05, -2.82, -5.05, -6.06, -7.07, 0]
        },
        {
            name: 'LTC*(-3)',
            type: 'line',
            data: [18.56, 0, -2.84, 14.48, 20.49, 16.02, 18.65, 0]
        },
        {
            name: 'LTC*3',
            type: 'line',
            data: [-5.21, 0, 6.11, -3.12, -10.13, -3.12, 13.56, 0]
        },
        {
            name: 'XRP*(-3)',
            type: 'line',
            data: [16.36, 0, -0.90, 11.81, 18.18, 14.54, 20.00, 0]
        },
        {
            name: 'XRP*3',
            type: 'line',
            data: [-13.71, 0, 1.27, -14.15, -12.95, -18.90, -19.49, 0]
        }
    ]
};
