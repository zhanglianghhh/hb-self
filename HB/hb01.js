    ...
    series: [
        {
            name: 'BCH*(-3)',
            type: 'line',
            data: [22.29, 0, -6.12, 7.58, 0, 0, 0, 0]
        },
        {
            name: 'BCH*3',
            type: 'line',
            data: [-0.49, 0, -0.64, -0.05, 0, 0, 0, 0]
        },
        {
            name: 'BTC*(-3)',
            type: 'line',
            data: [20.85, 0, -4.61, 6.58, 0, 0, 0, 0]
        },
        {
            name: 'BTC*3',
            type: 'line',
            data: [-11.51, 0, 7.80, -1.57, 0, 0, 0, 0]
        },
        {
            name: 'EOS*(-3)',
            type: 'line',
            data: [15.53, 0, -11.36, 6.81, 0, 0, 0, 0]
        },
        {
            name: 'EOS*3',
            type: 'line',
            data: [-3.24, 0, 0.35, -0.07, 0, 0, 0, 0]
        },
        {
            name: 'ETH*(-3)',
            type: 'line',
            data: [22.71, 0, -4.53, 3.19, 0, 0, 0, 0]
        },
        {
            name: 'ETH*3',
            type: 'line',
            data: [-14.82, 0, 8.26, 8.08, 0, 0, 0, 0]
        }
    ]
};
