    ...
    series: [
        {
            name: 'BCH*(-3)',
            type: 'line',
            data: [22.29, 0, -6.12, 7.58, 12.99, 7.99, 15.84, 47.75,
		  8.87]
        },
        {
            name: 'BCH*3',
            type: 'line',
            data: [-0.49, 0, -0.64, -0.05, -0.43, -0.49, -0.81, -1.90,
		  0.00]
        },
        {
            name: 'BTC*(-3)',
            type: 'line',
            data: [20.85, 0, -4.61, 6.58, 6.54, 1.57, 5.75, 28.75,
		  0.55]
        },
        {
            name: 'BTC*3',
            type: 'line',
            data: [-11.51, 0, 7.80, -1.57, -4.32, -0.60, -5.31, -26.36,
		  -6.23]
        },
        {
            name: 'EOS*(-3)',
            type: 'line',
            data: [15.53, 0, -11.36, 6.81, 11.36, 6.43, 12.12, 42.04,
		  12.40]
        },
        {
            name: 'EOS*3',
            type: 'line',
            data: [-3.24, 0, 0.35, -0.07, -0.42, -1.12, -1.12, -3.95,
		  0.00]
        },
        {
            name: 'ETH*(-3)',
            type: 'line',
            data: [22.71, 0, -4.53, 3.19, 11.16, 12.49, 19.73, 48.27,
		  4.43]
        },
        {
            name: 'ETH*3',
            type: 'line',
            data: [-14.82, 0, 8.26, 8.08, -5.49, -10.61, -15.62, -36.13,
		  -4.47]
        }
    ]
};
